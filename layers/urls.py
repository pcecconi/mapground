...
urlpatterns = [
    ...
    url(r'^public_wxs_raster_band/(?P<id_mapa>.+)/(?P<id_sld>\w+)/$', views.public_wxs_raster_band, name='public_wxs_raster_band'),
    url(r'^public_wxs_raster_band/(?P<id_mapa>.+)/$', views.public_wxs_raster_band, name='public_wxs_raster_band'),
